...
!function ($) {
    ...
    ModalManager.prototype = {
        ...
        removeContainer: function (modal) {
            ...
            if(modal.options.autoremove) modal.$element.remove();
        },
...
var bootbox = window.bootbox || (function(document, $) {
    ...
    that.dialog = function(str, handlers, options) {
        ...
        var parts = ["<div class='bootbox modal' tabindex='-1' data-autoremove='true' style='overflow:hidden;'>"];
